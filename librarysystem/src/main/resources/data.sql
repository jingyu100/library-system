...
INSERT INTO users (username, password, name, contact, memo, user_type) VALUES
                                                                           ('user001', '{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '김철수', '010-1234-5678', '개발팀', 'USER'),
                                                                           ('user002', '{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '이영희', '010-2345-6789', '디자인팀', 'USER'),
                                                                           ('user003', '{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '박민수', '010-3456-7890', '기획팀', 'USER'),
                                                                           ('user004', '{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '최지은', '010-4567-8901', '마케팅팀', 'USER'),
                                                                           ('user005', '{bcrypt}$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', '정수현', '010-5678-9012', '인사팀', 'USER');
...
INSERT INTO loans (user_id, book_id, loan_date, due_date, status) VALUES
                                                                      (2, 3, '2024-05-15 10:30:00', '2024-05-30 23:59:59', 'ACTIVE'),
                                                                      (3, 7, '2024-05-20 14:20:00', '2024-06-04 23:59:59', 'ACTIVE');

-- 샘플 대출 이력 데이터 (반납 완료)
INSERT INTO loans (user_id, book_id, loan_date, due_date, return_date, status) VALUES
                                                                                   (1, 1, '2024-04-01 09:00:00', '2024-04-16 23:59:59', '2024-04-14 16:30:00', 'RETURNED'),
                                                                                   (2, 4, '2024-04-05 11:15:00', '2024-04-20 23:59:59', '2024-04-18 10:45:00', 'RETURNED'),
                                                                                   (3, 8, '2024-04-10 13:45:00', '2024-04-25 23:59:59', '2024-04-22 15:20:00', 'RETURNED'),
                                                                                   (1, 5, '2024-04-20 10:00:00', '2024-05-05 23:59:59', '2024-05-03 14:10:00', 'RETURNED'),
                                                                                   (4, 2, '2024-05-01 12:30:00', '2024-05-16 23:59:59', '2024-05-14 09:45:00', 'RETURNED');